...
const SkillAssessment = () => {
  ...
  return (
    <div className="min-h-screen bg-white p-4 sm:p-8 md:p-12 font-sans">
      <h1 className="text-3xl font-bold text-gray-800 mb-2">Skill Assessment & Certification</h1>
      <p className="text-gray-500 mb-6">Test your abilities and earn certificates to showcase your skills</p>

      <div className="grid lg:grid-cols-3 gap-6">
        {/* Skills Section */}
        <div className="lg:col-span-2 space-y-6">
          <h2 className="text-xl font-semibold text-gray-700">Select a Skill to Assess</h2>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {skills.map((skill, i) => (
              <div key={i} className="bg-white rounded-xl shadow p-4 hover:shadow-md">
        ...
        <div className="space-y-6">
          <div className="bg-gray-100 rounded-xl p-6 shadow text-center min-h-[150px]">
            <h3 className="text-lg font-semibold text-gray-700">Selected Skill</h3>
            <p className="text-gray-500 mt-2">No Skill Selected</p>
            <p className="text-sm text-gray-400">Select a skill from the list to get started</p>
          </div>

          <div className="bg-white rounded-xl shadow p-6">
            <h3 className="text-lg font-semibold text-gray-700 mb-4">Your Certificates</h3>
            {certificates.map((cert, i) => (
              ...
              >
                <div>
                  ...
                  <div className="text-sm text-gray-500">Score: {cert.score}%</div>
                  <div className="text-xs text-gray-400">Issued: {cert.date}</div>
                </div>
