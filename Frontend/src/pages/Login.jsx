  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success && response.data.user.role === "user") {
        ...
        window.location.href = "/admin-profile"; // Change this to your desired route
      } else if (response.data.success && response.data.user.role === "owner") {
        // Redirect to owner dashboard or home page
        window.location.href = "/owner-profile"; // Change this to your desired route
      }
    } catch (error) {
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-white placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  />
                </div>
              </div>
